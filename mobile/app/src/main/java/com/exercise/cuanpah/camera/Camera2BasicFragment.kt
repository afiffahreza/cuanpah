...
package com.exercise.cuanpah.camera
...
import com.exercise.cuanpah.tflite.Classifier
import com.exercise.cuanpah.utils.ImageUtils
import java.io.File
import java.util.*
                ...
                if (isProcessingFrame) {
                    ...
                    activity?.runOnUiThread {
                        ...
                        confidenceTextView.text = String.format(
                            "%.2f",
                            (results?.get(0)?.confidence?.times(100))
                        ) + "%";
                    }
